...
(module+ test
  ...
  (check-equal? (my-atoi "    -42") -42)
  (check-equal? (my-atoi "4193 with words") 4193)
  (check-equal? (my-atoi "words with 4193") 0)
  (check-equal? (my-atoi "4294967296") 2147483647)
  (check-equal? (my-atoi "-4294967296") -2147483648)
  (check-equal? (my-atoi "") 0)
  (check-equal? (my-atoi " ") 0))
